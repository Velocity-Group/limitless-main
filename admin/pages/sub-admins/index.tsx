...
import { SubAdminSearchFilter } from '@components/user/sub-admin-search-filter';
...
export default class SubAdmins extends PureComponent<IProps> {
  _selectedUser: any;
  ...
  render() {
              ...
              menuOptions={[
                {
                  ...
                  children: (
                    <Link
                      href={{
                        pathname: '/sub-admins/update',
                        query: { id }
                      }}
                      as={`/sub-admins/update?id=${id}`}
                    >
                      <a>
                        <EditOutlined />
                        {' '}
    ...
    return (
      <>
        ...
        <BreadcrumbComponent breadcrumbs={[{ title: 'Sub Admins' }]} />
        <Page>
