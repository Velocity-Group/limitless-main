...
import {
  Row, Col, message, Button, Modal, Layout
} from 'antd';
...
import GroupChatPublisher from '@components/streaming/webrtc/groupchat/publisher';
...
class UserGroupChat extends PureComponent<IProps, IStates> {
  ...
  render() {
    ...
    const {
      processing, total, members, roomJoined, callTime,
      openPriceModal, openTipModal, streamList
    } = this.state;
