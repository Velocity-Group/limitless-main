...
class PerformerRegister extends PureComponent<IProps> {
  ...
  handleRegister = (data: any) => {
    const { registerPerformer: handleRegister } = this.props;
  ...
  async onGoogleLogin(resp: any) {
    if (!resp.tokenId) {
      message.error('Google login fail');
      return;
    }
    ...
    try {
      ...
      const error = await e;
      message.error(error && error.message ? error.message : 'Google login fail');
    } finally {
  ...
  render() {
    const {
      ui, registerPerformerData
    } = this.props;
    const { requesting: submiting } = registerPerformerData;
        ...
        <div className="main-container">
          <div className="login-box">
            <Row>
              ...
              >
                <div className="title">MODEL SIGN UP</div>
...
export default connect(mapStatesToProps, mapDispatchToProps)(PerformerRegister);
